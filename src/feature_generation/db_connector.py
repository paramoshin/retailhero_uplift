...
class DBConnector:
    ...
    def generate_purchase_features(
        ...
        subq_1 = session.query(
            ...
            func.sum(Products.is_alcohol.cast(Integer) * Purchases.product_quantity).label("n_alcohols_quantity"),
            func.sum(Products.is_alcohol.cast(Integer)).label("n_alcohols"),
            func.sum(Products.is_own_trademark.cast(Integer) * Purchases.product_quantity).label("n_own_trademark_quantity"),
            func.sum(Products.is_own_trademark.cast(Integer)).label("n_own_trademark"),
            func.sum(Products.netto * Purchases.product_quantity).label("sum_netto"),
            func.avg(Products.netto * Purchases.product_quantity).label("avg_netto"),

            func.count(distinct(Products.brand_id)).label("n_unique_brands"),
            func.count(distinct(Products.vendor_id)).label("n_unique_vendors"),
            func.count(distinct(Products.segment_id)).label("n_unique_segments"),
            func.count(distinct(Products.level_1)).label("n_unique_level_1"),
            func.count(distinct(Products.level_2)).label("n_unique_level_2"),
            func.count(distinct(Products.level_3)).label("n_unique_level_3"),
        ...
        subq_2 = session.query(
            ...
            func.sum(subq_1.c.n_alcohols_quantity).label("n_alchohol_products_quantity"),
            func.avg(subq_1.c.n_alcohols_quantity).label("avg_alchohol_products_in_purchase_quantity"),
            ...
            func.sum(subq_1.c.n_own_trademark_quantity).label("n_own_trademark_products_quantity"),
            func.avg(subq_1.c.n_own_trademark_quantity).label("avg_onw_trademark_in_purchase_quantity"),
            (func.sum(subq_1.c.n_own_trademark) / func.sum(subq_1.c.n_unique_products)).label("pct_own_trademark_products"),

            func.avg(subq_1.c.n_unique_brands).label("avg_unique_brands"),
            func.avg(subq_1.c.n_unique_vendors).label("avg_unique_vendors"),
            func.avg(subq_1.c.n_unique_segments).label("avg_unique_segments"),
            func.avg(subq_1.c.n_unique_level_1).label("avg_unique_level_1"),
            func.avg(subq_1.c.n_unique_level_2).label("avg_unique_level_2"),
            func.avg(subq_1.c.n_unique_level_3).label("avg_unique_level_3"),

            (func.avg(subq_1.c.n_unique_brands) / func.avg(subq_1.c.n_unique_products)).label("pct_unique_brands"),
            (func.avg(subq_1.c.n_unique_vendors) / func.avg(subq_1.c.n_unique_products)).label("pct_unique_vendors"),
            (func.avg(subq_1.c.n_unique_segments) / func.avg(subq_1.c.n_unique_products)).label("pct_unique_segments"),
            (func.avg(subq_1.c.n_unique_level_1) / func.avg(subq_1.c.n_unique_products)).label("pct_unique_level_1"),
            (func.avg(subq_1.c.n_unique_level_2) / func.avg(subq_1.c.n_unique_products)).label("pct_unique_level_2"),
            (func.avg(subq_1.c.n_unique_level_3) / func.avg(subq_1.c.n_unique_products)).label("pct_unique_level_3"),
        ...
        subq_last_month_2 = session.query(
            ...
            func.sum(subq_last_month_1.c.n_alcohols).label("last_month_n_alchohol_products"),
            func.avg(subq_last_month_1.c.n_alcohols).label("last_month_avg_alchohol_products_in_purchase"),
            func.sum(subq_last_month_1.c.n_alcohols_quantity).label("last_month_n_alchohol_products_quantity"),
            func.avg(subq_last_month_1.c.n_alcohols_quantity).label("last_month_avg_alchohol_products_in_purchase_quantity"),
            (func.sum(subq_last_month_1.c.n_alcohols) / func.sum(subq_last_month_1.c.n_unique_products)).label("last_month_pct_alcohol_products"),

            func.sum(subq_last_month_1.c.n_own_trademark).label("last_month_n_own_trademark_products"),
            func.avg(subq_last_month_1.c.n_own_trademark).label("last_month_avg_onw_trademark_in_purchase"),
            func.sum(subq_last_month_1.c.n_own_trademark_quantity).label("last_month_n_own_trademark_products_quantity"),
            func.avg(subq_last_month_1.c.n_own_trademark_quantity).label("last_month_avg_onw_trademark_in_purchase_quantity"),
            (func.sum(subq_last_month_1.c.n_own_trademark) / func.sum(subq_last_month_1.c.n_unique_products)).label("last_month_pct_own_trademark_products"),

            func.avg(subq_last_month_1.c.n_unique_brands).label("last_month_avg_unique_brands"),
            func.avg(subq_last_month_1.c.n_unique_vendors).label("last_month_avg_unique_vendors"),
            func.avg(subq_last_month_1.c.n_unique_segments).label("last_month_avg_unique_segments"),
            func.avg(subq_last_month_1.c.n_unique_level_1).label("last_month_avg_unique_level_1"),
            func.avg(subq_last_month_1.c.n_unique_level_2).label("last_month_avg_unique_level_2"),
            func.avg(subq_last_month_1.c.n_unique_level_3).label("last_month_avg_unique_level_3"),

            (func.avg(subq_last_month_1.c.n_unique_brands) / func.avg(subq_last_month_1.c.n_unique_products)).label("last_month_pct_unique_brands"),
            (func.avg(subq_last_month_1.c.n_unique_vendors) / func.avg(subq_last_month_1.c.n_unique_products)).label("last_month_pct_unique_vendors"),
            (func.avg(subq_last_month_1.c.n_unique_segments) / func.avg(subq_last_month_1.c.n_unique_products)).label("last_month_pct_unique_segments"),
            (func.avg(subq_last_month_1.c.n_unique_level_1) / func.avg(subq_last_month_1.c.n_unique_products)).label("last_month_pct_unique_level_1"),
            (func.avg(subq_last_month_1.c.n_unique_level_2) / func.avg(subq_last_month_1.c.n_unique_products)).label("last_month_pct_unique_level_2"),
            (func.avg(subq_last_month_1.c.n_unique_level_3) / func.avg(subq_last_month_1.c.n_unique_products)).label("last_month_pct_unique_level_3"),

            func.sum(subq_last_month_1.c.sum_netto).label("last_month_sum_sum_netto"),
            func.avg(subq_last_month_1.c.sum_netto).label("last_month_avg_sum_netto"),
            func.stddev(subq_last_month_1.c.sum_netto).label("last_month_stddev_sum_netto"),
            func.avg(subq_last_month_1.c.avg_netto).label("last_month_avg_avg_netto"),
            func.stddev(subq_last_month_1.c.sum_netto).label("last_month_stddev_avg_netto"),
        ...
        q = session.query(
            ...
            subq_2.c.n_alchohol_products_quantity,
            subq_2.c.avg_alchohol_products_in_purchase_quantity,
            subq_2.c.pct_alcohol_products,
            subq_2.c.n_own_trademark_products,
            subq_2.c.avg_onw_trademark_in_purchase,
            subq_2.c.n_own_trademark_products_quantity,
            subq_2.c.avg_onw_trademark_in_purchase_quantity,
            subq_2.c.pct_own_trademark_products,
            subq_2.c.avg_unique_brands,
            subq_2.c.avg_unique_vendors,
            subq_2.c.avg_unique_segments,
            subq_2.c.avg_unique_level_1,
            subq_2.c.avg_unique_level_2,
            subq_2.c.avg_unique_level_3,
            subq_2.c.pct_unique_brands,
            subq_2.c.pct_unique_vendors,
            subq_2.c.pct_unique_segments,
            subq_2.c.pct_unique_level_1,
            subq_2.c.pct_unique_level_2,
            subq_2.c.pct_unique_level_3,
            ...
            subq_last_month_2.c.last_month_n_alchohol_products,
            subq_last_month_2.c.last_month_avg_alchohol_products_in_purchase,
            subq_last_month_2.c.last_month_n_alchohol_products_quantity,
            subq_last_month_2.c.last_month_avg_alchohol_products_in_purchase_quantity,
            subq_last_month_2.c.last_month_pct_alcohol_products,
            subq_last_month_2.c.last_month_n_own_trademark_products,
            subq_last_month_2.c.last_month_avg_onw_trademark_in_purchase,
            subq_last_month_2.c.last_month_n_own_trademark_products_quantity,
            subq_last_month_2.c.last_month_avg_onw_trademark_in_purchase_quantity,
            subq_last_month_2.c.last_month_pct_own_trademark_products,
            subq_last_month_2.c.last_month_avg_unique_brands,
            subq_last_month_2.c.last_month_avg_unique_vendors,
            subq_last_month_2.c.last_month_avg_unique_segments,
            subq_last_month_2.c.last_month_avg_unique_level_1,
            subq_last_month_2.c.last_month_avg_unique_level_2,
            subq_last_month_2.c.last_month_avg_unique_level_3,
            subq_last_month_2.c.last_month_pct_unique_brands,
            subq_last_month_2.c.last_month_pct_unique_vendors,
            subq_last_month_2.c.last_month_pct_unique_segments,
            subq_last_month_2.c.last_month_pct_unique_level_1,
            subq_last_month_2.c.last_month_pct_unique_level_2,
            subq_last_month_2.c.last_month_pct_unique_level_3,
            subq_last_month_2.c.last_month_sum_sum_netto,
            subq_last_month_2.c.last_month_avg_sum_netto,
            subq_last_month_2.c.last_month_stddev_sum_netto,
            subq_last_month_2.c.last_month_avg_avg_netto,
            subq_last_month_2.c.last_month_stddev_avg_netto,
