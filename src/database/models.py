...
class Purchases(Base):
    ...
    express_points_received = Column("express_points_received", Integer, nullable=False)
    regular_points_spent = Column("regular_points_spent", Integer, nullable=False)
    express_points_spent = Column("express_points_spent", Integer, nullable=False)
